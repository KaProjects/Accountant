...
public class YearService {
    ...
    public YearModel getYearModel(int yearId){
        try {
            ...
            schemaModel.getClasses().get(2).getGroups().get(1).getAccounts().put(1, new SchemaModel.Clazz.Group.Account(1,Constants.AccountType.ASSET, "Hotovost"));
            schemaModel.getClasses().get(2).getGroups().get(1).getAccounts().put(2, new SchemaModel.Clazz.Group.Account(2,Constants.AccountType.ASSET, "Stravenky"));
            schemaModel.getClasses().get(2).getGroups().put(2, new SchemaModel.Clazz.Group(2,"Bankove Ucty"));
            schemaModel.getClasses().get(2).getGroups().get(2).getAccounts().put(1, new SchemaModel.Clazz.Group.Account(1, Constants.AccountType.ASSET, "Debetne"));
            ...
            model.getAccountModel().getAccounts().add(new AccountModel.Account("100","0", Constants.AccountType.ASSET,"default",""));
            model.getAccountModel().getAccounts().add(new AccountModel.Account("580","0-0", Constants.AccountType.ASSET,"default-exp",""));

            model.getAccountModel().getAccounts().add(new AccountModel.Account("211","0", Constants.AccountType.ASSET,"koruny",""));
            model.getAccountModel().getAccounts().add(new AccountModel.Account("211","1", Constants.AccountType.ASSET,"eura",""));
            model.getAccountModel().getAccounts().add(new AccountModel.Account("212","0", Constants.AccountType.ASSET,"default",""));
